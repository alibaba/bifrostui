const config = {
    ...
    modelCfg: {
      ...
      // 写单元测试使用的模型（测试效果较好的模型qwen-max-2025-01-25、qwen-coder-plus、deepseek-v3、qwen-coder-plus-latest），更多可用模型参考：https://bailian.console.aliyun.com/?spm=5176.12818093_47.resourceCenter.6.57ea16d0lfCepy#/model-market
