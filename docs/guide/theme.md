...
| 内置Token变量名              | 默认值                | 说明           |
| ---------------------------- | --------------------- | -------------- |
| --bui-color-bg-popover       | --bui-color-neutral-7 | 气泡背景色     |
| --bui-color-bg-alpha-light-9 | fade(#fff, 90%)       | 高亮-半透明90% |
| --bui-color-bg-alpha-light-7 | fade(#fff, 70%)       | 高亮-半透明70% |
| --bui-color-bg-alpha-light-5 | fade(#fff, 50%)       | 高亮-半透明50% |
| --bui-color-bg-alpha-light-3 | fade(#fff, 30%)       | 高亮-半透明30% |
| --bui-color-bg-alpha-light-1 | fade(#fff, 10%)       | 高亮-半透明10% |
| --bui-color-bg-alpha-dark-9  | fade(#000, 90%)       | 暗黑-半透明90% |
| --bui-color-bg-alpha-dark-7  | fade(#000, 70%)       | 暗黑-半透明70% |
| --bui-color-bg-alpha-dark-5  | fade(#000, 50%)       | 暗黑-半透明50% |
| --bui-color-bg-alpha-dark-3  | fade(#000, 30%)       | 暗黑-半透明30% |
| --bui-color-bg-alpha-dark-1  | fade(#000, 10%)       | 暗黑-半透明10% |
...
| --bui-color-bg-popover       | fade(#484f58, 70%) | 气泡背景色         |
| --bui-color-bg-alpha-light-9 | fade(#161b22, 90%) | 高亮-半透明90%     |
| --bui-color-bg-alpha-light-7 | fade(#161b22, 70%) | 高亮-半透明70%     |
| --bui-color-bg-alpha-light-5 | fade(#161b22, 50%) | 高亮-半透明50%     |
| --bui-color-bg-alpha-light-3 | fade(#161b22, 30%) | 高亮-半透明30%     |
| --bui-color-bg-alpha-light-1 | fade(#161b22, 10%) | 高亮-半透明10%     |
| --bui-color-bg-alpha-dark-9  | fade(#484f58, 90%) | 暗黑-半透明90%     |
| --bui-color-bg-alpha-dark-7  | fade(#484f58, 70%) | 暗黑-半透明70%     |
| --bui-color-bg-alpha-dark-5  | fade(#484f58, 50%) | 暗黑-半透明50%     |
| --bui-color-bg-alpha-dark-3  | fade(#484f58, 30%) | 暗黑-半透明30%     |
| --bui-color-bg-alpha-dark-1  | fade(#484f58, 10%) | 暗黑-半透明10%     |
