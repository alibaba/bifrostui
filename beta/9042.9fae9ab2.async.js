"use strict";(self.webpackChunk_bifrostui_monorepo=self.webpackChunk_bifrostui_monorepo||[]).push([[9042],{40792:function(c,e,n){n.r(e),n.d(e,{default:function(){return t.default}});var t=n(28050)},11092:function(c,e){e.Z=`import React, { useState } from 'react';
...
`},85972:function(c,e){e.Z=`// Automatically generated by cli tools, please do not modify this file directly
import createSvgIcon from '../utils/createSvgIcon';

export default createSvgIcon(
  '<defs><path d="M0 0h80v80H0V0Z" id="a"/></defs><path d="M56.105 4a2.842 2.842 0 0 1 2.842 2.842v2.842h6.636C71.339 9.684 76 14.35 76 20.114v24.923c-.348.986-1.255 1.486-2.721 1.5-1.47.014-2.44-.471-2.909-1.454l-.055-.001V20.113a4.734 4.734 0 0 0-4.732-4.745h-6.636v2.843a2.842 2.842 0 1 1-5.684 0v-2.843H26.737v2.843a2.842 2.842 0 0 1-5.684 0v-2.843h-6.636a4.739 4.739 0 0 0-4.733 4.745v45.458a4.734 4.734 0 0 0 4.733 4.745L45 70.315v.029c1.035.321 1.58 1.162 1.634 2.522l.005.231c0 1.497-.547 2.455-1.639 2.877V76H14.417C8.661 76 4 71.335 4 65.57V20.114C4 14.354 8.663 9.684 14.417 9.684h6.636V6.842a2.842 2.842 0 1 1 5.684 0v2.842h26.526V6.842A2.842 2.842 0 0 1 56.105 4Zm-2.024 45.872L62.5 58.29l8.419-8.42a2.976 2.976 0 0 1 4.21 4.21l-8.42 8.419 8.42 8.419a2.976 2.976 0 0 1-4.21 4.21l-8.419-8.42-8.419 8.42a2.976 2.976 0 0 1-4.21-4.21l8.42-8.419-8.42-8.419a2.976 2.976 0 0 1 4.21-4.21Zm-7.45-9.398a2.842 2.842 0 0 1 0 5.684H22a2.842 2.842 0 1 1 0-5.684h24.632ZM58 26.264a2.842 2.842 0 0 1 0 5.683H22a2.842 2.842 0 1 1 0-5.684h36Z" fill-rule="nonzero" fill="#000"/>',
  'CalendarCancelOutilnedIcon',
);
