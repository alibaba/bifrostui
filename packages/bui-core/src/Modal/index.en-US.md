...
The Modal component provides a robust foundation for creating dialogs, drawers, popovers, or any other overlays.

## Features

- 📚 **Multi-level Management** - Supports stacking management of multiple Modals
- 🔒 **Scroll Lock** - Prevent background page scroll penetration
- ♿ **Accessibility Support** - Built-in ARIA attributes and keyboard navigation
- 🎨 **Highly Customizable** - Supports custom backgrounds, containers, and transition animations

## When to Use

- When you want the user to handle tasks without navigating away from the page to avoid disrupting workflows
- When you need to display important information or obtain user confirmations
- When you need to display complex content such as forms, image previews, etc.

## Basic Usage

The simplest usage of Modal is to control visibility via the `open` attribute.
    ...
    <Stack>
      ...
      >
        ...
        >
          ...
          >
            This is a basic Modal example. Click the outside area or the close
